...
class SLLTest extends SLL {
	...
	/**
	 * Test method for {@link linkedList.SLL#append(java.lang.Object)}.
	...
	/**
	 * Test method for {@link linkedList.SLL#add(java.lang.Object)}.
	...
	/**
	 * Test method for {@link linkedList.SLL#add(java.lang.Object, int)}.
	...
	/**
	 * Test method for {@link linkedList.SLL#clear()}.
	 */
	@Test
	void testClear() {
		list.add(a);
	...
	/**
	 * Test method for {@link linkedList.SLL#remove()}.
	...
	/**
	 * Test method for {@link linkedList.SLL#removeLast()}.
	...
	/**
	 * Test method for {@link linkedList.SLL#remove(int)}.
...
//		assertThrows(IndexOutOfBoundsException.class, list.remove(1));
	...
	/**
	 * Test method for {@link linkedList.SLL#get()}.
	...
	/**
	 * Test method for {@link linkedList.SLL#getLast()}.
	...
	/**
	 * Test method for {@link linkedList.SLL#get(int)}.
	...
	/**
	 * Test method for {@link linkedList.SLL#set(java.lang.Object, int)}.
	 */
	@Test
	void testSet() {
		list.append(a);//0
	...
	/**
	 * Test method for {@link linkedList.SLL#contains(java.lang.Object)}.
	 */
	@Test
	void testContains() {
		list.append(a);//0
	...
	/**
	 * Test method for {@link linkedList.SLL#indexOf(java.lang.Object)}.
	 */
	@Test
	void testIndexOf() {
		list.append(a);//0
	...
	/**
	 * Test method for {@link linkedList.SLL#size()}.
	 */
	@Test
	void testSize() {
		assertEquals(0, list.size());
	...
	/**
	 * Test method for {@link linkedList.SLL#isEmpty()}.
	 */
	@Test
	void testIsEmpty() {
		assertEquals(true,list.isEmpty());
	...
	/**
	 * Test method for {@link linkedList.SLL#toString()}.
	 */
	@Test
	void testToString() {
		assertEquals("[]",list.toString());
	...
	/**
	 * Test method for {@link linkedList.SLL#append(java.util.ArrayList)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link linkedList.SLL#getList()}.
	 */
	@Test
	void testGetList() {
		list.append(a);
